...
const TILES: Tile[] = [
  ...
  { id: 'nghe-so', label: 'Nghe & chọn số', emoji: '👂', color: '#26a69a' },
  { id: 'nhieu-it', label: 'Nhiều hơn / Ít hơn', emoji: '⚖️', color: '#ab47bc' },
  { id: 'so-sanh-so', label: 'Số lớn / Số bé', emoji: '📊', color: '#ef5350' },
